...
// Ported from react-bits (Beams, JS + CSS variant) at the user's request, for
// the Login.jsx background. Needs three / @react-three/fiber / @react-three/drei
// (pinned to the React-18-compatible v8/v9 lines — the latest @react-three/fiber
// requires React 19, which this project doesn't use). Left close to the
// original source; only the CSS import path changed.
